...
game 'rdr3'
description 'Vorp Stores Farmers Market, AI store, Buy and Sell, Locations, Items'
...
vorp_github 'https://github.com/craftedbylittledragons/vorp_stores_farmersmarket'
